...
class SSP
{
	 ...
	 * @param  array    $bindings Matriz de valores de ligação PDO de bind() para ser
	 * usado para escapar strings com segurança. Observe que isso pode ser fornecido como
	 * string de consulta SQL se nenhuma ligação for necessária.
